...
import NotificationHandler from 'grabbit/src/lib/NotificationHandler';
...
export default class NotifService {
  ...
  localNotification({soundName, text, title}) {
    this.lastId++;
    PushNotification.localNotification({
      ...
      tag: 'localNotification', // (optional) add tag to message
      ...
      title: title || 'Default Notification Title', // (optional)
      message: text || 'Default notification Message', // (required)
